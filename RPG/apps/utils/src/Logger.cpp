...
namespace HE_Arc::RPG
{
    ...
    /**
     * @brief Write on movements log
     * @param _log The log
     * @param _who Who we want to log
     */
    void Logger::writeMovements(string _log, LoggerWho _who)
    {
        string fileName = "";
        ...
        Logger::writeLog(Logger::pathMovements, fileName, _log);
    }

    /**
     * @brief Write on objects log
     * @param _log The log
     */
    void Logger::writeObjects(string _log)
    {
        Logger::writeLog(Logger::pathRoot, "Objects.log", _log);
    }
